...
module.exports = async function handler(req, res) {
  ...
  if (!apiKey) return res.status(500).json({ error: 'Formularz nie został jeszcze aktywowany. Zadzwoń pod numer +48 690 760 079.' });
